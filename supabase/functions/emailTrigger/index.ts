...
serve(async (req) => {
  ...
  from: 'ReviewZone <noreply@reviewzone.ai>',
  to: review.email_id,
...
<tr>
        ...
        <td align="center" style="padding-bottom: 0px;">
          <span style="font-size: 32px; color: #2563eb; display: block;">☆</span>
        </td>
</tr>
<tr>
  <td align="center" style="padding-bottom: 10px; padding-top: 0px;">
